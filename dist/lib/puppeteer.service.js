...
import { AuditError, ErrorCodes, detectBlockedSite } from '../utils/errorHandler.js';
...
export class PuppeteerService {
    ...
    async loadWebsite(url, retryCount = 0) {
        ...
        try {
            ...
            if (retryCount < MAX_RETRIES) {
                logger.warn(`Page load failed, retrying...`, { url, retryCount, error: error.message });
                return this.loadWebsite(url, retryCount + 1);
            }
            throw new AuditError({
