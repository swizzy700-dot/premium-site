        ...
        <div className="text-center space-y-6">
          ...
          <div className="space-y-4 max-w-4xl mx-auto">
            <p className="text-xs text-neutral-500 font-light leading-relaxed">
              All content, designs, text, graphics, and intellectual property on this website are the exclusive property of Mainline (MLR) and may not be reproduced, distributed, or used without prior written consent.
            </p>
